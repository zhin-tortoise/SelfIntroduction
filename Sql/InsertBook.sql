...
insert into book values (
    ...
    'Head First デザインパターン',
    'デザインパターンについて書かれた参考書。
    Gang of Fourで紹介されているデザインパターンがわかりやすく解説されている。
    FactoryパターンやSingletonパターンなど既に知っているパターンのほか、DecoratorパターンやCommandパターンなど今までに知らなかったパターンを知ることができた。
    パターンを用いての開発がこれからできるようになったが、パターンを使用しすぎることには注意が必要だとも書かれていたため、必要になった時を見定めてパターンを適用していきたい。
    ',
    '../../Picture/HeadFirstDesignPattern.jpg'
);
...
insert into book values (
    ...
    1,
    '珠玉のプログラミング',
    'データ構造とアルゴリズムについて書かれた参考書。
    問題定義の重要性や選択するデータ構造やアルゴリズムによって実行時間が大幅に異なる場合があることを学んだ。
    封筒裏の計算のコラムでは、概算の重要性が記載されていた。簡単に時間を見積もることができるため、適宜使用していこうと思った。
    コードチューニングのコラムでは、チューニングの具体的なやり方が記載されていた。今後、コードチューニングが必要になった際には適宜参照していきたいと思う。
    ',
    '../../Picture/ProgrammingPearls.jpg'
);
...
insert into book values (
    ...
    1,
    'アーキテクチャパターン',
    '企業システムの設計のパターンが記載された参考書。
    トランザクションスクリプトとドメインモデルなど、それまであまり意識していなかったパターンが論じれており勉強になった。
    ドメインモデルのほうが将来の拡張性が優れているとのことなので、今後はできる限りドメインモデルを使用して開発していきたいと思う。
    アクティブレコードなども開設されており面白かった。Ruby on Railsではアクティブレコードが採用されているため、このフレームワークを使用する際には役立ちそうな知識だと思う。
    テンプレートビューなどの普段使用しているパターンも解説されており面白かった。
    ',
    '../../Picture/PatternsOfEnterpriseApplicationArchitecture.jpg'
);
...
insert into book values (
    ...
    'エクストリームプログラミング',
    'XPの開発手法について記載された参考書。
    XPの価値、原則、プラクティスなどが記載されており、勉強になった。
    価値ではXPで重要なことが定義されており、原則ではそれらの価値を実施するうえで必要なものを定義しており、プラクティスでは実際に行うことが記載されていた。
    プラクティスには、テストファーストプログラミングやインクリメンタルな設計などが紹介されており、本来はXPはチームの開発手法ではあるがこれらは個人でも行えるため今後実施していきたいと思う。
    もし可能なら、チームでXPを用いた開発を試すことができたらと考えている。
    ',
    '../../Picture/ExtremeProgramming.jpg'
);
